...
#define configUSE_TRACE_FACILITY				0 // TRACING ON / OFF

#define configUSE_16_BIT_TICKS					0
#define configIDLE_SHOULD_YIELD					1
#define configUSE_MUTEXES						1
#define configQUEUE_REGISTRY_SIZE				8
#define configCHECK_FOR_STACK_OVERFLOW			0 // Can slow the system down. Change at rollout.
#define configUSE_RECURSIVE_MUTEXES				1
#define configUSE_MALLOC_FAILED_HOOK			0 // Default (1), 0 in 2015
...
#define configUSE_TICKLESS_IDLE					1 // Was set to 1 in 2015

/* Run time stats gathering definitions. */
#define configGENERATE_RUN_TIME_STATS	0  // Was set to 1 in 2015
